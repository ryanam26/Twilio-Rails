...
class StrainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create strain" do
    assert_difference('Strain.count') do
      post strains_url, params: { strain: { strain_description: @strain.strain_description, strain_name: @strain.strain_name } }
    end
  ...
  test "should update strain" do
    patch strain_url(@strain), params: { strain: { strain_description: @strain.strain_description, strain_name: @strain.strain_name } }
